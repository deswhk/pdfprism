...
- PR 14a (foundation, **shipped**): adapter grouping + session-defaults restyle on Options change. PR 14b (right-click Edit/Remove Group, **shipped**): adaptive context menu + EditGroupDialog. PR 14c (Manage Marks dialog) planned.
